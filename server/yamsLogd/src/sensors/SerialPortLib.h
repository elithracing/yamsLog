 ...
 *      Authors: Philipp Koschorrek et al. 
 *
 *
 * copied from:
 ...
 *
 * source: 	http://www.webalice.it/fede.tft/serial_port/serial_port.html
 * 			http://gitorious.org/serial-port
 */

#ifndef SERIALPORTLIB_H_
#define SERIALPORTLIB_H_
